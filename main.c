...
int logIn;
char passWord[10],userName[20],lpassWord[10],luserName[20],firstName[20],lastName[20];
char cuserName[]={"anas"};
...
int main()
{
	...
	seat=(int **)calloc(101,sizeof(int *));//increase size
	for (i=0;i<3;i++)
...
int changeprize(int prize)
{
	...
	scanf("%s",&pass);
	if (strcmp(pass,pak)==0) //comparing string 
	{
...
int choice1(void)
{
	...
	printf(" ==================================================================\n");
	printf("||             1- To Register account:           ||\n");
	printf("||             2- To Log in:           ||\n");
	printf("||             3- To edit price of ticket (only admin):           ||\n");
	printf("||             4- To view reserved tickets (only admin):          ||\n");
	printf("||             5- To puchase ticket:                              ||\n");
...
void registration(void)
 ...
 void login(void){
    ...
    printf("Password: ");
    scanf("%s",lpassWord);
    if ((strcmp(cuserName,luserName) == 0 && strcmp(cpassword,lpassWord)==0)||(strcmp(userName,luserName) == 0 && strcmp(passWord,lpassWord)==0))
    {
        printf("\nSuccessfully done !.....\n");
    }
